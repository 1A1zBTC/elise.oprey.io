...
const PAGES = [
  ...
  'mob-soccer/', 'monkey-swing/', 'mr-grizzles/', 'naughty-shelf/', 'pet-lovers/', 'phasmophobia/',
  'picwits/', 'scroot-rooms/', 'smeeches-lasagna/', 'snakes-and-ladders/', 'street-fighter/', 'sumo/',
