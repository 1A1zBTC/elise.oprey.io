...
const CACHE = 'el-games-v1';

const PAGES = [
  '/',
  'battleships/', 'bunny-dig/', 'catch-the-treats/', 'crossy-pets/', 'flappy-dog/',
  'frog-feast/', 'hungry-pig/', 'kit-clash/', 'kitten-jump/', 'match-it/',
  'mob-soccer/', 'monkey-swing/', 'naughty-shelf/', 'picwits/', 'scroot-rooms/',
  'snakes-and-ladders/', 'whack-a-mole/'
];
const ASSETS = [
